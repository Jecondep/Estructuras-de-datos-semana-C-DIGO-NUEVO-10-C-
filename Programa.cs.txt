...
﻿class Program
{
    static void Main()
    {
        ...
        // Usamos HashSet para evitar duplicados y así garantizar un conjunto único de identidades
        ...
        // Usaremos un bucle while para asegurarnos de alcanzar exactamente 75 ciudadanos únicos
        ...
        // Calcular el listado de ciudadanos que no son vacunados, excluyendo a los vacunados con Pfizer y AstraZeneca del total
        var noVacunados = totalCiudadanos.Except(vacunadosPfizer).Except(vacunadosAstrazeneca).ToList();

        // Calcular el listado de ciudadanos que si han recibido ambas vacunas, encontrando la intersección entre Pfizer y AstraZeneca
        var vacunadosDosDoses = vacunadosPfizer.Intersect(vacunadosAstrazeneca).ToList();

        // Calcular el listado de ciudadanos que únicamente han recibido la vacuna de Pfizer, excluyendo a los que también tienen AstraZeneca
